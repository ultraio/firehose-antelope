...
require (
	...
	github.com/streamingfast/cli v0.0.4-0.20230608140431-f501fec4f1ce // indirect
	...
	github.com/streamingfast/node-manager v0.0.2-0.20230406142433-692298a8b8d2 // indirect
